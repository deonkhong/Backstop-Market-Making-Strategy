...
// Configuration
const std::string BINANCE_PRODUCTION_API_URL = "https://api.binance.com";
const std::string BINANCE_FUTURES_TESTNET_API_URL = "https://testnet.binancefuture.com";

const std::string API_KEY = "yourkey";
const std::string SECRET_KEY = "secret";
const std::string SYMBOL = "BTCUSDT";
const double BUY_BASIS_POINTS = 50.0;
const double SELL_BASIS_POINTS = 75.0;
const double ORDER_QUANTITY = 0.1;
const int REPRICE_INTERVAL_SECONDS = 2;
...
void runMarketMakingStrategy() {
    ...
    while (true) {
        double referencePrice = fetchReferencePrice();
        Prices prices = calculatePrices(referencePrice, BUY_BASIS_POINTS, SELL_BASIS_POINTS);
        ...
        std::this_thread::sleep_for(std::chrono::seconds(REPRICE_INTERVAL_SECONDS));
    }
}
